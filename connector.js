...
class ServiceNowConnector {
   ...
   * @description Checks if request function responded with evidence of a
   ...
   *   from ServiceNowConnector object options and parameter callOptions
   ...
   *   calls this.sendRequest().
   *
   * @param {iapCallback} callback - a callback function
   * @param {object|string} callback.data - The API's response. Will be an object if sunnyday path.
   *   Will be HTML text if hibernating instance.
   * @param {error} callback.error - The error property of callback.
   */
